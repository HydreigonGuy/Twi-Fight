...
scene_t *fill_play_game_scene(void)
{
    ...
    fill_btn(&scene->btn, my_str_concat(IMAGE_PATH, "btn/chemist_tower_btn.png"), 1010, 200);
    ...
    fill_btn(&scene->btn, my_str_concat(IMAGE_PATH, "btn/roxane_tower_btn.png"), 1010, 500);
